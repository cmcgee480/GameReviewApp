...
<body>
    <section data-aos="fade-down" data-aos-duration="1000" data-aos-delay='600' id="header">
    ...
    <div class="jumbotron text-center" style="height:60vh;">
        <div class="intro">
            <h2 data-aos="fade" data-aos-duration="800">Leave a Game Review below..
                <i class="fa fa-gamepad"></i>
            </h2>
        </div>
    </div>
        ...
        <div data-aos='fade-up' 
            ...
            foreach ($gamedata as $value) {
                echo "  <img src='{$value['URL']}' alt='image' width ='250' height='250'>
                        <h1>{$value["gameTitle"]}</h1>
                        <p>Score: {$value["score"]}
                        <br>Date: {$value["date"]}
                        <br>Game ID: {$value["gameID"]}<p>
                        ...
                        <label for='exampleFormControlTextarea1' class='form-label'>Please re-enter GameID:  <input type='number' name='gamenumber' required /></label>
                         <label for='exampleFormControlTextarea1' class='form-label'>EMAIL: <input type='text' name='useremail' required /></label>
