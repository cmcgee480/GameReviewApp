...
<body>
    ...
    <div class="jumbotron text-center" style="height:50vh;">
        <div class="intro">
            <h2 class='headertwo' data-aos="fade" data-aos-duration="400" data-aos-delay='500'>We have edited your favourites..
                <i class="fa fa-gamepad"></i>
            </h2>
        </div>
        <div data-aos="fade-up" data-aos-duration="600" data-aos-delay='600' class='reviewbox'>
            <a href='viewfavourites.php' class='btn btn-primary'>BACK TO FAVOURITES</a>
    ...
    <script>
        swal("Game deleted from favourites!");
    </script>
