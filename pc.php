...
$endp = "http://cmcgee17.lampt.eeecs.qub.ac.uk/gameAPI/index.php?platforms=1000&api_k=RpUSEnXg4BOI1I9f7hDV";
...
//buttons to use in other page, just taking them out for editing purposes

//<a href='review.php?info={$value["gameID"]}' class='btn btn-primary'>REVIEW THIS GAME</a>
// <a href='review.php?info={$value["gameID"]}' class='btn btn-primary'>REVIEW THIS GAME</a>
//<h1>By Metacritic: {$value["criticName"]}</h1>
    ...
    <div class="jumbotron text-center" style="height:60vh;">
        <div class="intro ">
            <div class='gameHeader'>
                <h2  >Games <i class="fa fa-gamepad"></i></h2>
