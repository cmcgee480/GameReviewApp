...
$gameID = $conn->real_escape_string($_POST["gamenumber"]);
$email = $conn->real_escape_string($_POST["useremail"]);

$sql = "INSERT INTO practice_reviewtable (userID,user_email,gameID,user_review)
                 VALUES(null,'$email','$gameID','$review')";
...
<body>
   ...
   <div class='content'>
      <div data-aos='fade-up' data-aos-duration='900' data-aos-delay='400' class='reviewbox'>
         ...
         <?php
         echo "
                        <h1>Thank you $email for your review.</h1>
