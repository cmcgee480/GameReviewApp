    ...
    <div class="jumbotron text-center" style="height:60vh;">
        <div class="intro ">
            <div class='gameHeader'>
                <h2 data-aos="fade" data-aos-duration="2000">User Reviews <i class="fa fa-gamepad"></i></h2>
            </div>
    ...
    <div class="Maincontent">
        ...
        foreach ($gamedata as $value) {
            ...
            data-aos-delay='800' class='card' style='width: 400 >
                ...
                <div class='card-body'>
                 <h5 class='card-title'>{$value['gameTitle']}</h5>
                <p class='card-text'>User: {$value['user_email']}<br>{$value['review']}</p>
                 <a href='inspect.php?info={$value['gameID']}' class='btn btn-primary'>Go to Game</a>
                </div>
                 </div>";
        }
        ?>
