...
$end = "http://cmcgee17.lampt.eeecs.qub.ac.uk/gameAPI/?update&api_k=HZ5kC1FWcajAuNNBvRPy";
...
<body>
    ...
    <div class="jumbotron text-center">
        <div class="intro">
            <h2 data-aos='fade-down' data-aos-duration='2000'>Go back to Admin Homepage
                <i class="fa fa-gamepad"></i>
            </h2>
        </div>
    </div>
    ...
    <div class='content'>
        <div class='reviewbox'>
         <a data-aos='fade-down' data-aos-duration='2000' href='index.php' class='btn btn-primary'>BACK</a>
