...
<body>
    ...
    <div class="jumbotron text-center" style="height:50vh;">
        <div class="intro">
            <h5 data-aos="fade" data-aos-duration="800" data-aos-delay='500'>GENERATE ADMIN API KEY <i class="fa fa-gamepad"></i>
    ...
    <div class="container">
        <form data-aos="fade-up" data-aos-duration="1000" data-aos-delay='600'action="adminapikey.php" method="POST">
            <div class="form-group">

                <input type="text" class="form-control" name="u_name" id="name" aria-describedby="emailHelp" placeholder="Enter username..">
