...
if (isset($_GET['info'])) {
    ...
    $number = $_GET['info'];
    $endp = "http://cmcgee17.lampt.eeecs.qub.ac.uk/gameAPI/index.php?reviewID=$number&api_k=RpUSEnXg4BOI1I9f7hDV";
    ...
    <div data-aos="fade" data-aos-duration="2000" class="container">
        ...
        foreach ($gamedata as $value) {
            echo "
                      ...
                      <label for='userID'>Please re-enter user ID <input type='number' name='usernumber' required /></label>
                      ...
                      <p id='iduser'>User ID: {$value['userID']}</p>
                      <a href='uploadreview.php'<button><input type='submit'class='btn btn-primary' value='SUBMIT'></button></a>
                      </form>
                      ";
        }
        ?>
