...
<body>
    ...
    <div class="jumbotron text-center" style="height:90vh;">
        <div class="intro ">
            ...
            <div data-aos="fade-up" data-aos-duration="2000" data-aos-delay='400' class="input-group">
        ...
        <ul class="grid columns-3">
            ...
            <li>
                <a class='btn btn-outline-light' href='pc.php'>PC</a>
                </liv>

            <li>
                <a class='btn btn-outline-light' href='3ds.php'>3DS</a>
                </liv>

            <li>
                <a class='btn btn-outline-light' href='wii.php'>WII</a>
                </liv>

            <li>
                <a class='btn btn-outline-light' href='ps4.php'>PS4</a>
                </liv>
            <li>
                <a class='btn btn-outline-light' href='xboxone.php'>XBOX ONE</a>
                </liv>
            <li>
                <a class='btn btn-outline-light' href='switch.php'>SWITCH</a>
                </liv>
