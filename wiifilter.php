...
if (isset($_GET['limit'])) {
    ...
    $number = $_GET['limit'];
    $endp = "http://cmcgee17.lampt.eeecs.qub.ac.uk/gameAPI/index.php?platform=1290&numrows=$number&api_k=RpUSEnXg4BOI1I9f7hDV";
        ...
        <div class="intro ">
            <div class='gameHeader'>
                ...
                <div data-aos="fade" data-aos-duration="2000" data-aos-delay='400' class='filterbar'>
                    <a href='wiifilter.php?limit=5'>5</a>
                    <a href='wiifilter.php?limit=10'>10</a>
                    <a href='wiifilter.php?limit=20'>20</a>
                    <a href='wiifilter.php?limit=50'>50</a>
                </div>
            </div>
